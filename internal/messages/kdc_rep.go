...
func (k *ASRep) Verify(cfg *krb5conf.Krb5Config, creds *credentials.Credentials, asReq ASReq) (bool, error) {
...
func (k *TGSRep) Verify(cfg *krb5conf.Krb5Config, tgsReq TGSReq) (bool, error) {
